...
<Popover.Root bind:open>
	<Popover.Trigger
		...
		data-no-drag
		class={[
			'grid size-[22px] place-items-center rounded-md bg-transparent text-[19px] leading-none drop-shadow-[0_2px_2px_rgba(15,23,42,0.25)] transition hover:scale-105 focus-visible:ring-2 focus-visible:ring-neutral-950/20 focus-visible:outline-none disabled:cursor-default disabled:opacity-70',
	...
	>
		...
		{:else}
			...
			<Icon class="size-[17px] stroke-[2.6]" />
		{/if}
	</Popover.Trigger>
	<Popover.Portal>
		<Popover.Content
			...
			strategy="fixed"
			data-no-drag
			class="z-[220] grid gap-2 rounded-md border bg-white p-2 shadow-2xl shadow-neutral-950/20"
		>
